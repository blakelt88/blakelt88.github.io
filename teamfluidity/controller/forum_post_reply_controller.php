...
if ($_SESSION['uid']) {
	if (isset($_POST['reply_submit'])) {
		...
		if (($res) && ($res2) && ($res3)) {
			echo "<p>Your reply has been successfully posted. <a href='../view/forum_view_topic.php?cid=".$cid."&tid=".$tid."'>Click here to return to the topic.</a></p>";
		} else {
