...
<body>
    ...
    echo "<p>$error</p>";
                    ...
                    <h3 style="color:white; font-family: 'Titillium Web', sans-serif;">What's on your mind?</h3>
                    <textarea class="edit-input-box lastname-width" name="comment" id="comment"></textarea>
                </div>
                <div class="col-sm-12">
                    <button class="new-post-button" type="submit" name="action" value="viewcomment">Post</button>
                </div>
</form>
</div>
